...
# Use an environment variable for the MongoDB URI, falling back to localhost.
# Set MONGO_URI in your OS or VS Code launch config when using Atlas.
...
try:
    ...
    # If the DB connection fails (e.g., bad DNS / invalid URI), print a helpful message,
    # but keep the app running so you can fix the configuration.
    print('ERROR: Unable to connect to MongoDB. Please set a valid MONGO_URI.\n', str(e))
    mongo = None
